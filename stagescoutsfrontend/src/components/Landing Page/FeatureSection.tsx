        ...
        <div className="w-full px-18 pt-30 pb-20">
            ...
            <div className="grid grid-cols-12">
                { events?.map((event, index) => (
                    <div key={index} id={event.eventId.toString()} className="transition-all transform duration-300 ease-in-out hover:scale-105 hover:shadow-2xl hover:shadow-gray-400 mx-4 pb-5 mt-5 border-1 border-gray-300 rounded-xl col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-4">
